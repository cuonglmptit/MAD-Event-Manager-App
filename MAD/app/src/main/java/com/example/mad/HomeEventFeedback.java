...
public class HomeEventFeedback extends AppCompatActivity {
    ...
    private void setupAddFeedbackButtons(Dialog dialogAddFeedback, Event event) {
        ...
        btnCancelAddFeedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(HomeEventFeedback.this, "Cancel", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnSendAddFeedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (message != null && !message.isEmpty()) {
                    ...
                    Toast.makeText(HomeEventFeedback.this, "Vui lòng nhập suy nghĩ của bạn!", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (radBtnPositive.isChecked()) {
                    ...
                    Toast.makeText(HomeEventFeedback.this, "Chưa chọn đánh giá!", Toast.LENGTH_SHORT).show();
                    return;
                }

                feedback.setUserId(sharedUserStatusPreferences.getInt("userId", 0));
                feedback.setEventId(event.getId());
                RequestQueue requestQueue = Volley.newRequestQueue(HomeEventFeedback.this);
                ...
                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, new JSONObject(params), new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        try {
                            ...
                            dialogAddFeedback.dismiss();
                            fetchFeedbackData();
                            Toast.makeText(HomeEventFeedback.this, message, Toast.LENGTH_SHORT).show();
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        if (volleyError.networkResponse != null && volleyError.networkResponse.data != null) {
                            try {
                                ...
                                Toast.makeText(HomeEventFeedback.this, errorMessage, Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(HomeEventFeedback.this, "Có lỗi xảy ra", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private void fetchFeedbackData() {
        ...
        feedbackAPI.getAllFeedbackOfEvent(event.getId()).enqueue(new Callback<ArrayList<Feedback>>() {
            ...
            public void onFailure(Call<ArrayList<Feedback>> call, Throwable t) {
                ...
                Toast.makeText(HomeEventFeedback.this, "loi get du lieu", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void setupOverall(ArrayList<Feedback> feedbacks) {
        ...
        txtViewNegative.setText(txtViewNegative.getText() + "" + negativeCount);
        txtViewPositive.setText(txtViewPositive.getText() + "" + positiveCount);
        txtViewNeutral.setText(txtViewNeutral.getText() + "" + neutralCount);
    }
